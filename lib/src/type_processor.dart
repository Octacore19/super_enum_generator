...
import 'package:enum_super/enum_super.dart';
...
bool dataFieldRequired(DartObject obj) =>
    ConstantReader(obj).read('important').boolValue;
...
String? dataFieldType(DartObject obj) {
  return _genericOf(ConstantReader(obj).objectValue.type!)!.getDisplayString(withNullability: false)
